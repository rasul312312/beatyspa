            ...
            var sets = [
                    {
                        ...
                        scale: 2,
                        points: [
                            {label: '                Rasu', connections: [], url: '/expertise/representation',cVParents:[2]},
                            {label: '      rasul2', connections: [0], url: '/expertise/collegiate',cVParents:[2]},
                            {label: '              Rasul312', connections: [0,1], url: '/expertise/media',cVParents:[2]},
                            ...
                            {label: '                     art222', connections: [8,9,10], url: '/expertise/fashion',cVParents:[1,2,3]},
                        ]
