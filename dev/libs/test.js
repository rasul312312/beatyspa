                ...
                var sets = [
                        {
                            ...
                            scale: 2,
                            points: [
                                {label: '                athletes', connections: [], url: '/expertise/representation',cVParents:[2]},
                                {label: '      collegiate athletics', connections: [0], url: '/expertise/collegiate',cVParents:[2]},
                                {label: '              leagues', connections: [0,1], url: '/expertise/media',cVParents:[2]},
                                {label: '      sports training', connections: [0,1,2], url: '/expertise/sports-training',cVParents:[2]},
                                {label: '                  models', connections: [1,2,3], url: '/expertise/representation',cVParents:[3]},
                                {label: '                 events', connections: [2,3,4], url: '/expertise/events',cVParents:[1,2,3]},
                                {label: '                licensing', connections: [3,5], url: '/expertise/licensing',cVParents:[1,2,3]},
                                {label: '                   media', connections: [3,6], url: '/expertise/media',cVParents:[1,2,3]},
                                {label: '          original content', connections: [6,7], url: '/expertise/original',cVParents:[1,2,3]},
                                {label: '                     brands', connections: [6,7,8], url: '/expertise/brand',cVParents:[1,2,3]},
                                {label: '                     fashion', connections: [7,8,9], url: '/expertise/fashion',cVParents:[1,2,3]},
                                {label: '                     art', connections: [8,9,10], url: '/expertise/fashion',cVParents:[1,2,3]},
                            ]
